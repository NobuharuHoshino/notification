...
class SaSendPushServiceImplTest {
        ...
        void sendPush_001() {
                // Arrange
                SaSendPushServiceImpl sut = new SaSendPushServiceImpl(saNtfInfoRepository, notificationHubUtil,
                                jsapUtil);
        ...
        void validateRequired_001() throws Exception {
                ...
                SaSendPushServiceImpl sut = new SaSendPushServiceImpl(saNtfInfoRepository, notificationHubUtil,
                                jsapUtil);
                Method m = SaSendPushServiceImpl.class.getDeclaredMethod("validateRequired", SendPushRequestDto.class);
        ...
        /**
         * クラス：SaSendPushServiceImpl createPayload APNSの場合にAPNS用payloadが返ることを確認するテストケース
         */
        @Test
        ...
        void sendPush_009() {
                ...
                try (org.mockito.MockedConstruction<com.fasterxml.jackson.databind.ObjectMapper> om = org.mockito.Mockito
                                .mockConstruction(
