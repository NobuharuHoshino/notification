...
// // Arrange
// SendPrimaryContactServiceImpl sut = new
// SendPrimaryContactServiceImpl(smsCountryUtil, sendGridUtil,
// personalInfoUtil);

// SendPrimaryContactRequestDto request =
// mock(SendPrimaryContactRequestDto.class);
...
// PersonalInfoResponseDto.ContactDto contact =
// mock(PersonalInfoResponseDto.ContactDto.class);
...
// when(personalInfoUtil.getPersonalInfoApiResponse("iu",
// "corr")).thenReturn(response);

// HttpEntity<String> entity = mock(HttpEntity.class);
// when(smsCountryUtil.createRequest(anyString(), eq("sms-body"),
// eq("0"))).thenReturn(entity);
...
// .thenReturn("msg");
// cu.when(() ->
// CommonUtil.getResultCode(anyString())).thenReturn("PC_SUCCESS");
// cu.when(() ->
// CommonUtil.normalizePhoneNumber(anyString())).thenReturn("09012345678");
...
// verify(smsCountryUtil, times(1)).sendSmsCountry(eq(entity),
// eq("090-1234-5678"));
...
// .thenReturn("msg");
// cu.when(() ->
// CommonUtil.getResultCode(anyString())).thenReturn("PC_GET_PERSONALINFO_EMPTY");
...
// .thenReturn("msg");
// cu.when(() ->
// CommonUtil.getResultCode(anyString())).thenReturn("PC_FIELD_MISSING");
...
// .thenReturn("msg");
// cu.when(() ->
// CommonUtil.getResultCode(anyString())).thenReturn("PC_INVALID_BRAND");
...
// eq("html"), eq("1")))
// .thenReturn(mail);
// doThrow(new TscEMailException(400, "a@example.com",
// "title")).when(sendGridUtil)
...
// // Act + Assert
// assertThrows(CustomException.class, () -> sut.sendPrimaryContact(request,
// header));
// }
// }
...
// when(smsCountryUtil.createRequest(anyString(), eq("sms-body"),
// eq("0"))).thenReturn(entity);
// doThrow(new TscSMSException(400, "NG",
// "090")).when(smsCountryUtil).sendSmsCountry(eq(entity),
// eq("090"));
...
// .thenReturn("msg");
// cu.when(() ->
// CommonUtil.normalizePhoneNumber(anyString())).thenReturn("090");
...
// when(personalInfoUtil.getPersonalInfoApiResponse("iu", "corr")).thenThrow(new
...
// personalInfoUtil);
// Method m =
// SendPrimaryContactServiceImpl.class.getDeclaredMethod("validateRequired",
...
// personalInfoUtil);
// Method m =
// SendPrimaryContactServiceImpl.class.getDeclaredMethod("isValidBrdCd",
// String.class);
// m.setAccessible(true);
...
// personalInfoUtil);
// Method m =
// SendPrimaryContactServiceImpl.class.getDeclaredMethod("sendRequest",
// List.class,
...
// /*
// * =========================================================
// * sendRequest (reflection) : && の右辺(primaryContactFlag)がfalseとなる分岐を補完
// * =========================================================
// */
