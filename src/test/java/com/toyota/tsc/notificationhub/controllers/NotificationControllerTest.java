...
class NotificationControllerTest {
        ...
        @BeforeEach
        void setUp() {
                target = new NotificationController(registService, pushService, primaryContactService);
        }
        ...
        void registNotificationDeviceInfo_001() {
                ...
                when(registService.registDeviceInfo(eq(body), any(RequestHeaderDto.class))).thenReturn(expected);
                ...
                ResponseEntity<ResponseDto> actual = target.registNotificationDeviceInfo(
                                apiKey, contentType, connection, acceptEncoding, correlationId, userAccessKey,
                                xSmartgbook, body);
                ...
                verify(registService, times(1)).registDeviceInfo(eq(body), headerCaptor.capture());
        ...
        void registNotificationDeviceInfo_003() {
                ...
                when(registService.registDeviceInfo(eq(body), any(RequestHeaderDto.class))).thenThrow(expectedEx);
                ...
                verify(registService, times(1)).registDeviceInfo(eq(body), any(RequestHeaderDto.class));
                verifyNoMoreInteractions(registService);
        }
        ...
        void registNotificationDeviceInfo_004() {
                ...
                when(registService.registDeviceInfo(eq(body), any(RequestHeaderDto.class))).thenReturn(null);
        ...
        void sendPush_001() {
                ...
                ResponseDto expected = mock(ResponseDto.class);
                when(pushService.sendPush(eq(body), any(RequestHeaderDto.class))).thenReturn(expected);
        ...
        void sendPush_003() {
                ...
                RuntimeException expectedEx = new RuntimeException("boom");
                when(pushService.sendPush(eq(body), any(RequestHeaderDto.class))).thenThrow(expectedEx);
                ...
                // 確認
                assertSame(expectedEx, actualEx);
                verify(pushService, times(1)).sendPush(eq(body), any(RequestHeaderDto.class));
                verifyNoMoreInteractions(pushService);
        }
        ...
        void sendPush_004() {
                ...
                when(pushService.sendPush(eq(body), any(RequestHeaderDto.class))).thenReturn(null);
        ...
        void sendPrimaryContact_001() {
                ...
                ResponseDto expected = mock(ResponseDto.class);
                when(primaryContactService.sendPrimaryContact(eq(body), any(RequestHeaderDto.class)))
                                .thenReturn(expected);
                ...
                verify(primaryContactService, times(1)).sendPrimaryContact(eq(body), headerCaptor.capture());
                RequestHeaderDto header = headerCaptor.getValue();
        ...
        void sendPrimaryContact_003() {
                ...
                // 確認
                assertSame(expectedEx, actualEx);
                verify(primaryContactService, times(1)).sendPrimaryContact(eq(body), any(RequestHeaderDto.class));
                verifyNoMoreInteractions(primaryContactService);
        }
        ...
        void sendPrimaryContact_004() {
                ...
                when(primaryContactService.sendPrimaryContact(eq(body), any(RequestHeaderDto.class))).thenReturn(null);
