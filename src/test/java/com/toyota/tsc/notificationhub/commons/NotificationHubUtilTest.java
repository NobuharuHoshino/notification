...
// ファイルパス: src/test/java/com/toyota/tsc/notificationhub/commons/NotificationHubUtilTest.java
...
class NotificationHubUtilTest {
    ...
    void buildFcmV1Payload_004() {
        ...
        // Act
        CustomException ex = assertThrows(CustomException.class, () -> sut.buildFcmV1Payload(body));
    ...
    void buildApnsPayload_003() {
        ...
        // Act
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> sut.buildApnsPayload(body));
    ...
    void buildApnsPayload_004() {
        ...
        try (MockedConstruction<com.fasterxml.jackson.databind.ObjectMapper> mocked = mockConstruction(
                com.fasterxml.jackson.databind.ObjectMapper.class, (mock, ctx) -> {
                    com.fasterxml.jackson.databind.ObjectMapper real = new com.fasterxml.jackson.databind.ObjectMapper();
                    when(mock.createObjectNode()).thenAnswer(inv -> real.createObjectNode());
                    when(mock.valueToTree(any())).thenAnswer(inv -> real.valueToTree(inv.getArgument(0)));
            ...
            // Act
            CustomException ex = assertThrows(CustomException.class, () -> sut.buildApnsPayload(body));
