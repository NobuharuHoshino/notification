...
public class SaNtfInfoRepositoryImpl implements SaNtfInfoRepositoryIF {
    ...
    @Autowired
    public SaNtfInfoRepositoryImpl(
            SaNtfInfoMapper saNtfInfoMapper,
            PropertiesUtil propertiesUtil) {
        this.saNtfInfoMapper = saNtfInfoMapper;
    ...
    public int insert(SaNtfInfoEntity entity) {
        return saNtfInfoMapper.insert(entity);
    }
    ...
    public int update(SaNtfInfoEntity entity) {
        return saNtfInfoMapper.update(entity);
    }
    ...
    public SaNtfInfoEntity select(String internalUserId) {
        return saNtfInfoMapper.select(internalUserId);
    }
    ...
    public int delete(String internalUserId) {
        return executeWithRetry(() -> saNtfInfoMapper.delete(internalUserId),
                propertiesUtil.getRetryCount());
    }
    ...
    public int upsert(SaNtfInfoEntity entity) {
        return executeWithRetry(() -> saNtfInfoMapper.upsert(entity), propertiesUtil.getRetryCount());
    }
