...
@Repository
@Profile("!local")
public class NotificationVinListRepositoryImpl implements NotificationVinListRepositoryIF {
    private final NotificationVinListMapper notificationVinListMapper;
    private final PropertiesUtil propertiesUtil;

    @Autowired
    public NotificationVinListRepositoryImpl(
            NotificationVinListMapper notificationVinListMapper,
            PropertiesUtil propertiesUtil) {
        this.notificationVinListMapper = notificationVinListMapper;
    ...
    public List<NotificationVinListEntity> select(Integer registrationSerialNumber, Integer isLinked) {
        return notificationVinListMapper.select(registrationSerialNumber, isLinked);
    }
