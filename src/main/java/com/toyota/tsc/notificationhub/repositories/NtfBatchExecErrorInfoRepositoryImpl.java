...
@Repository
@Profile("!local")
public class NtfBatchExecErrorInfoRepositoryImpl implements NtfBatchExecErrorInfoRepositoryIF {
    private final NtfBatchExecErrorInfoMapper ntfBatchExecErrorInfoMapper;
    private final PropertiesUtil propertiesUtil;

    @Autowired
    public NtfBatchExecErrorInfoRepositoryImpl(
            NtfBatchExecErrorInfoMapper ntfBatchExecErrorInfoMapper,
            PropertiesUtil propertiesUtil) {
        this.ntfBatchExecErrorInfoMapper = ntfBatchExecErrorInfoMapper;
    ...
    public int insert(NtfBatchExecErrorInfoEntity entity) {
        return executeWithRetry(() -> ntfBatchExecErrorInfoMapper.insert(entity),
